...
public class SecondPass extends DepthFirstAdapter {
    ...
    public void caseAIncrementStmt(AIncrementStmt node){
        ...
        if(!arr.equals("")){
            codePart = codePart + "la $t" + lastInReg + " , " + id + "\n " ;
            //get the number from the array
            String arrNum = arr.substring(1, arr.length() - 1) ;
            codePart = codePart + "li $s" + lastOutReg +  " , " + arrNum + "\n" ; 
            codePart = codePart + "add $s" + lastOutReg + " , t" + lastOutReg + "\n" ;
            codePart = codePart + "add $s" + lastOutReg + " , t" + lastOutReg + "\n" ;
            codePart = codePart + "add $t" + (lastInReg + 1) + " , t" + lastInReg + " , " + " $s" + lastOutReg + "\n";
            codePart = codePart + "lw $t" + lastInReg + ", 0($t" + (lastInReg + 1) + ") \n" ;
            codePart = codePart + "addi $s" + lastOutReg + " , $t" + lastInReg + " , 1 \n" ;
            codePart = codePart + "sw $s" + lastOutReg + " , 0($t" + (lastInReg + 1) + ") \n" ;  
        }
        else {
