...
Productions
	...
	methodstmtseq =
		...
		| {assignment} id optionalidarray assignment get lparen rparen semicolon
	...
	stmt =
		...
		| {switch} switch [firstlparen]:lparen expr [firstrparen]:rparen lcurly case [secondlparen]:lparen number [secondrparen]:rparen [firstcolon]:colon [firststmtseq]:stmtseq optlbreak optionalswitchcases default [secondcolon]:colon [secondstmtseq]:stmtseq rcurly
		;
	optlidlist =
