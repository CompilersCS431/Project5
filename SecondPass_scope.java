...
/*	
	...
	public void caseAForStmt(AForStmt node) {
		...
		node.getExpr().apply(this);
                ...
                Variable v ;
                if(peekType.equals("")){
                    v = symbolTable.getVar(scopeId);
                    
                }
                else {
                    v = new Variable(scopeId, peekType);
                    symbolTable.addVar(v);
                }
	...
	public void caseAPutStmt(APutStmt node) {
		...
		String put = stack.pop();
            ...
            if(symbolTable.containsVar(idScope))
            {
                ...
                if(type.equals("INT"))
                {
                    codePart = codePart + "lw $t" + varReg + " , " + getId + "\n" ;
                ...
                {
                    codePart = codePart + "la $t" + varReg + " , " + getId + "\n" ;
                    codePart = codePart + "move $a0 , $t" + varReg + "\n" ; 
                    //print string
                    codePart = codePart + "li $v0 , 4 \n" ;
                    codePart = codePart + "syscall \n" ;
	...
	public void caseAIncrementStmt(AIncrementStmt node){
		...
		temp = "";
                ...
                codePart = codePart + "lw $t" + lastInReg + " , " + getId + "\n" ;
                codePart = codePart + "addi $s" + lastOutReg + " , $t" + lastInReg + " , 1 \n" ;
                codePart = codePart + "sw $s" + lastOutReg + " , " + getId + "\n" ;
	...
	public void caseAIdarrayFactor(AIdarrayFactor node) {
		...
		temp = stack.pop();
                ...
                String reg = "$s" + regNum ;
                codePart = codePart + "lw " + reg + " , " + getId + "\n" ;
                String mipsCode = "lw " + reg + " , " + getId + "\n";
